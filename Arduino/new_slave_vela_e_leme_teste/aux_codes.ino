...
void com_pixhawk_vela(int corrente_motor, int theta_s_atual, int velocidade_motor){
...
void com_pixhawk_leme(int corrente_motor, int theta_r_atual, int velocidade_motor){
