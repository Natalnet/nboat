...
namespace concert_service_msgs
{
  ...
  {
    public:
      typedef concert_service_msgs::CaptureResourcePairRequest _pair_request_type;
      _pair_request_type pair_request;
      typedef concert_service_msgs::CaptureResourcePairResponse _pair_response_type;
