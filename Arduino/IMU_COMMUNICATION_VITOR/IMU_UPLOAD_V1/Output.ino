...
void output_sensors_selct()
{
  if( MY_SELECT_FLAG == 'a'){
  Serial.print(int(accel[0])); Serial.print("    ");
  Serial.print(int(accel[1])); Serial.print("    ");
  Serial.print(int(accel[2])); Serial.println();}
  
  else if( MY_SELECT_FLAG == 'm'){
    
  Serial.print(int(magnetom[0])); Serial.print("    ");
  Serial.print(int(magnetom[1])); Serial.print("    ");
  Serial.print(int(magnetom[2])); Serial.println();}  
  
  else if( MY_SELECT_FLAG == 'g'){
  
  Serial.print(int(gyro[0])); Serial.print("    ");
  Serial.print(int(gyro[1])); Serial.print("    ");
  Serial.print(int(gyro[2])); Serial.println();}  
...
void output_sensors()
{
  ...
  else if (output_mode == OUTPUT__MODE_SENSORS_CALIB)
  {
    ...
    else if (output_format == OUTPUT__FORMAT_SELCT)
      output_sensors_selct(); 
